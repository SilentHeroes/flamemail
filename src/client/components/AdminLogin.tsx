      ...
      {token ? (
        <section className="flex flex-col gap-4 rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <span className="inline-grid h-9 w-9 place-items-center rounded-lg bg-zinc-700/40">
        ...
        <section className="rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-6">
          <div className="mb-2 flex items-center gap-1.5">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-zinc-300">Reserved Access</span>
          </div>
          ...
          <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
            <label className="block space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-700/60 bg-zinc-800/80 px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-600 outline-none transition-colors focus:border-zinc-300/30 focus:ring-1 focus:ring-zinc-300/20"
              />
            </label>
            ...
            <button
              className="flex items-center gap-1.5 rounded-lg bg-zinc-100 px-5 py-2.5 text-sm font-semibold text-zinc-900 transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
              type="submit"
